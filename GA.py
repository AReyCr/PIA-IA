...
weights_s = [
    ...
    [106.0, 153.0, 83.0, 97.0, 7.0, 45.0, 131.0, 17.0, 44.0, 88.0, 244.0, 102.0, 213.0, 85.0, 118.0, 1.0, 37.0, 41.0, 3.0, 22.0, 68.0, 22.0, 11.0, 15.0, 55.0, 17.0, 100.0, 20.0, 77.0, 25.0, 184.0, 13.0, 132.0, 92.0, 10.0, 255.0, 147.0, 150.0, 166.0, 165.0, 25.0, 51.0, 269.0, 33.0, 33.0, 44.0, 6.0, 221.0, 81.0, 58.0]
]
...
def ratio(st):
    ...
    total_wei = 0
    for i in range(len(st)):
        total_sum = total_sum + ((values[i]/weights[i]) * st[i])
    for i in range(len(st)):
        total_wei = total_wei + (st[i] * weights[i])
    if total_wei > capacity:
        return 0
...
for i in range(10):
    for j in range(50):
        ...
        solution = greedy_knapsack()

        end_time = time.time()

        total_time = end_time - start_time 

        print(i+1, j+1, value(solution), total_time, best_value)
